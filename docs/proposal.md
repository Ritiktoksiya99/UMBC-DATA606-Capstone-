...
**PowerPoint Presentation:** [PowerPoint Presentation](https://docs.google.com/presentation/d/1k20b5UBP4FAW23bhAScNXH4WFKzHuA_C/edit?usp=sharing&ouid=118054097307591414694&rtpof=true&sd=true) 
...
|----------------------|-------------|-----------------------------------------------------------------------------|
| Diabetes_012         | Categorical | Diabetes status of the respondent                                           |
| HighBP               | Categorical | Indicates whether the respondent has high blood pressure                    |
| HighChol             | Categorical | Indicates whether the respondent has high cholesterol                       |
| CholCheck            | Categorical | Whether the respondent had a cholesterol check within the past 5 years      |
| BMI                  | Numerical   | Body Mass Index                                                             |
| Smoker               | Categorical | Indicates whether the respondent has smoked at least 100 cigarettes in life |
| Stroke               | Categorical | Indicates whether the respondent has ever been told they had a stroke       |
| HeartDiseaseorAttack | Categorical | History of coronary heart disease or myocardial infarction                  |
| PhysActivity         | Categorical | Indicates physical activity in the past 30 days (excluding work)            |
| Fruits               | Categorical | Indicates daily fruit consumption                                           |
| Veggies              | Categorical | Indicates daily vegetable consumption                                      |
| HvyAlcoholConsump    | Categorical | Indicates heavy alcohol consumption                                        |
| AnyHealthcare        | Categorical | Indicates whether the respondent has any form of healthcare coverage        |
| NoDocbcCost          | Categorical | Indicates inability to see a doctor due to cost in the past 12 months       |
| GenHlth              | Categorical | Self-reported general health status                                         |
| MentHlth             | Numerical   | Number of days mental health was not good in the past 30 days               |
| PhysHlth             | Numerical   | Number of days physical health was not good in the past 30 days             |
| DiffWalk             | Categorical | Indicates serious difficulty walking or climbing stairs                     |
| Sex                  | Categorical | Biological sex of the respondent                                            |
| Age                  | Categorical | Age group category of the respondent                                        |
| Education            | Categorical | Highest level of education completed                                        |
| Income               | Categorical | Annual household income category                                            |
