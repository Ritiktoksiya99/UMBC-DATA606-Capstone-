...
This folder contains all project documentation for the Diabetes Risk Prediction capstone project.
...
| Capstone_Project_.pptx | PowerPoint presentation slides |
| Ritik_Resume_Final.pdf | Author's resume |

## Project Links

- [Project Proposal](proposal.md)
- [Full Project Report](report.md)
- [PowerPoint Presentation](Capstone_Project_.pptx)
...
Capstone Advisor: Dr. Chaojie (Jay) Wang  
